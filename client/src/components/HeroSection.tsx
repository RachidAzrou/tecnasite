...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative bg-tecnarit-dark text-white overflow-hidden">
      {/* Code animation in background - now available on all devices */}
        ...
        <div className="h-full w-full relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[#1E1E3F] flex flex-col justify-center overflow-hidden">
            <div className="w-full h-full flex items-center justify-center">
              <motion.div 
                className="w-[95%] max-w-2xl bg-[#1E1E3F] rounded-lg overflow-hidden shadow-2xl opacity-30 lg:opacity-50"
...
function applyDiscount(total, discount) {
  ...
  return total - discount;
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-7xl lg:pb-24 xl:pb-32">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-10 pointer-events-none z-5">
