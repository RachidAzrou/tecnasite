...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative bg-tecnarit-dark text-white overflow-hidden">
      {/* Code animation in background - only visible on mobile */}
        ...
        <div className="h-full w-full relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[#1E1E3F] flex flex-col justify-center overflow-hidden">
            <div className="w-full h-full flex items-center justify-center">
              <motion.div 
                className="w-[95%] max-w-2xl bg-[#1E1E3F] rounded-lg overflow-hidden shadow-2xl opacity-30"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 0.3, y: 0 }}
                transition={{ duration: 0.8, delay: 0.3 }}
              >
                {/* Mobile code editor elements */}
...
function applyDiscount(total, discount) {
  ...
  return total - discount;
      ...
      {/* Desktop side code animation - original version */}
      <div className="hidden lg:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div className="h-64 w-full relative sm:h-72 md:h-96 lg:w-full lg:h-full overflow-hidden">
          {/* Code testing animation */}
          <div className="absolute inset-0 bg-[#1E1E3F] flex flex-col justify-center overflow-hidden">
            <div className="w-full h-full flex items-center justify-center">
              <motion.div 
